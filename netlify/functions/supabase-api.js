...
// Überprüfen auf fehlende Environment Variables
if (!supabaseUrl) throw new Error('SUPABASE_URL ist erforderlich');
if (!supabaseAnonKey) throw new Error('SUPABASE_ANON_KEY ist erforderlich');
if (!supabaseServiceKey) throw new Error('SUPABASE_SERVICE_ROLE_KEY ist erforderlich');

// Die Supabase-JS Bibliothek erwartet Optionen in einem bestimmten Format
